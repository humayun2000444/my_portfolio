...
let portfolioData = {
    personalInfo: {
        ...
        address: "House no 31/B, Block C, Road no 4, Munsurabad, Adabor, Dhaka",
    ...
    skills: [
        ...
        { id: "5", name: "CSS3", category: "Frontend", level: 90 },
        { id: "6", name: "Java", category: "Backend", level: 88 },
        { id: "7", name: "Spring Boot", category: "Backend", level: 85 },
        { id: "8", name: "C", category: "Backend", level: 80 },
        { id: "9", name: "C++", category: "Backend", level: 78 },
        { id: "10", name: "FreeSWITCH", category: "VoIP", level: 80 },
        { id: "11", name: "Asterisk", category: "VoIP", level: 75 },
        { id: "12", name: "Kamailio", category: "VoIP", level: 70 },
        { id: "13", name: "WebRTC", category: "VoIP", level: 85 },
        { id: "14", name: "PostgreSQL", category: "Database", level: 82 },
        { id: "15", name: "MySQL", category: "Database", level: 80 }
    ],
    projects: [
        {
            id: "1",
